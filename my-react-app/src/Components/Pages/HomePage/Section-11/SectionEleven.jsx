...
const headerContent = [
  { id: 1, image: imagesItems[0], title: 'Silver' },

  { id: 2, image: imagesItems[1], title: 'Gold' },

  { id: 3, image: imagesItems[2], title: 'No name' },

  { id: 4, image: imagesItems[3], title: 'General' },
];
...
const dataBaseNameOne = [
  ...
  { number: '3', name: 'Name v2' },

  { number: '7', name: 'Name v4' },

  { number: '8', name: 'Name v4' },

  { number: '10', name: 'Name v4' },
];
...
const dataBaseNameTwo = [
  ...
  { number: '12', name: 'Name v2' },

  { number: '14', name: 'Name v3' },

  { number: '17', name: 'Name v4' },

  { number: '18', name: 'Name v4' },

  { number: '20', name: 'Name v4' },
];
...
const dataBaseNameThree = [
  ...
  { number: '22', name: 'Name v2' },

  { number: '24', name: 'Name v3' },

  { number: '25', name: 'Name v4' },

  { number: '27', name: 'Name v4' },

  { number: '33', name: 'Name v4' },
];
...
const dataBaseNameFour = [
  ...
  { number: '35', name: 'Name v2' },

  { number: '36', name: 'Name v3' },
];
